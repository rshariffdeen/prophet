...
#define CLANG_WRAP_PATH "/home/rshariffdeen/workspace/prophet/wrap"

/* the extra include path arguments that need to pass to clang when build AST
   tree */
#define EXTRA_CLANG_INCLUDE_PATH " -I/usr/local/include  -I/usr/local/bin/../lib/clang/3.4/include  -I/usr/include/x86_64-linux-gnu  -I/usr/include  "
